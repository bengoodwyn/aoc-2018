...
TEST(Day1Part1, InThisExampleTheResultingFrequencyIs3) {
  ...
  ASSERT_EQ(3, day1part1(std::array<int,4>{+1, -2, +3, +1}));
}

TEST(Day1Part1, ExampleResultsIn3) {
  // +1, +1, +1 results in  3
  ASSERT_EQ(3, day1part1(std::array<int,3>{+1, +1, +1}));
}

TEST(Day1Part1, ExampleResultsIn0) {
  // +1, +1, -2 results in  0
  ASSERT_EQ(0, day1part1(std::array<int,3>{+1, +1, -2}));
}

TEST(Day1Part1, ExampleResultsInMinus6) {
  // -1, -2, -3 results in -6
  ASSERT_EQ(-6, day1part1(std::array<int,3>{-1, -2, -3}));
}
